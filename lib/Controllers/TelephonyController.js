...
var TelephonyController = {
     ...
     */
    phonePlayback : function(audioUrl, number, callback){
     ...
     */
    verifySecurityCode : function(securityCode, callback){
     ...
     */
    hLRLookup : function(number, countryCode, callback){
     ...
     */
    phoneVerify : function(number, codeLength, countryCode, languageCode, playbackDelay, securityCode, callback){
     ...
     */
    sMSVerify : function(number, codeLength, countryCode, languageCode, securityCode, callback){
        //Assign default values
