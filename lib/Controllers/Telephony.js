...
class Telephony {
     ...
     * in this country.<br/>If not set numbers are assumed to be in
     ...
     * <ul><li>MP3</li><li>WAV</li><li>OGG</ul></ul>You can use the
     * following MP3 URL for testing:<br/>https://www.neutrinoapi.com/test-
     * files/test1.mp3
     *
     * @callback    The callback function that returns response from the API call
     *
