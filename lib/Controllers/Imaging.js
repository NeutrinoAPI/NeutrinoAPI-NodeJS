...
class Imaging {
     ...
     * @param {int} width Width to resize to (in px)
     * @param {int} height Height to resize to (in px)
    ...
    static imageResize(imageUrl, width, height, format, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/image-resize'}`;
     ...
     * @param {string} fgColor (optional) The QR code foreground color (you should always use a
     * dark color for this)
     * @param {string} bgColor (optional) The QR code background color (you should always use a
     * light color for this)
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static qRCode(content, width, height, fgColor, bgColor, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/qr-code'}`;
     ...
     * center, bottom-right
     * @param {int} width (optional) If set resize the resulting image to this width (preserving
     * aspect ratio)
     * @param {int} height (optional) If set resize the resulting image to this height (preserving
     * aspect ratio)
     *
     * @callback    The callback function that returns response from the API call
     *
    ...
    static imageWatermark(imageUrl,
        ...
        let _queryBuilder = `${_baseUri}${'/image-watermark'}`;
     ...
     * @param {double} zoom (optional) Set the zoom factor when rendering the page (2.0 for double
    ...
    static hTML5Render(content,
        ...
        let _queryBuilder = `${_baseUri}${'/html5-render'}`;
