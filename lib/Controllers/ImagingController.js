...
var ImagingController = {
     ...
     * @return {binary}
     */
    qRCode : function(content, bgColor, fgColor, height, width, callback){
     ...
     * @return {binary}
     */
    hTMLToPDF : function(content, htmlWidth, margin, title, callback){
        //Assign default values
     ...
     * @return {binary}
     */
    imageResize : function(height, imageUrl, width, format, callback){
        //Assign default values
        format = format || "png";
     ...
     * @return {binary}
     */
    imageWatermark : function(imageUrl, watermarkUrl, format, height, opacity, position, width, callback){
        //Assign default values
        format = format || "png";
        opacity = opacity || 50;
