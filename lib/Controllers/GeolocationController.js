...
var GeolocationController = {
     ...
     */
    iPInfo : function(ip, reverseLookup, callback){
     ...
     */
    geocodeAddress : function(address, countryCode, languageCode, callback){
        //Assign default values
     ...
     */
    geocodeReverse : function(latitude, longitude, languageCode, callback){
        //Assign default values
        languageCode = languageCode || "en";
