...
var DataToolsController = {
     ...
     */
    createPhoneValidate : function(number, countryCode, callback){
     ...
     */
    createUserAgentInfo : function(userAgent, callback){
     ...
     * @return {binary}
     */
    createCodeHighlight : function(content, type, addKeywordLinks, callback){
     ...
     */
    createBadWordFilter : function(content, censorCharacter, callback){
     ...
     */
    createConvert : function(fromType, fromValue, toType, callback){
     ...
     */
    createEmailValidate : function(email, fixTypos, callback){
        //Assign default values
     ...
     * @return {binary}
     */
    createHTMLClean : function(content, outputType, callback){
     ...
     */
    createHTMLExtract : function(content, tag, attribute, baseUrl, callback){
