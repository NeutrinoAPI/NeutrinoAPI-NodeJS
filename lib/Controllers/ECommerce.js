...
class ECommerce {
     ...
     * number)
     * @param {string} customerIp (optional) Pass in a customers remote IP address. The API will
     * then determine the country of the IP address and match it against
     * the BIN country. This feature is designed for fraud prevention
    ...
    static bINLookup(binNumber, customerIp, callback) {
        ...
        let _queryBuilder = `${_baseUri}${'/bin-lookup'}`;
